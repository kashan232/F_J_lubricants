...
class CategoryAndSubCategoryController extends Controller
{
    ...
    public function category()
    {
        if (Auth::id()) {
            ...
            $Categories = Category::where('admin_or_user_id', $userId)->get(); // Adjust according to your database structure
    ...
    public function sub_category()
    {
        if (Auth::id()) {
            ...
            $Categories = Category::where('admin_or_user_id', $userId)->get(); // Adjust according to your database structure
            $Sub_Categories = SubCategory::where('admin_or_user_id', $userId)->get(); // Adjust according to your database structure
